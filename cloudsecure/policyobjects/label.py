...
from cloudsecure import IllumioException
from cloudsecure.util import JsonObject, Reference, MutableObject, pce_api
...
@dataclass
@pce_api('labels', endpoint='/labels', is_sec_policy=False)
